...
func NewService(gitWalker gitwalker.Service, fileWalker filewalker.Service, extractor extractor.Service) *service {
	return &service{gitWalker: gitWalker, fileWalker: fileWalker, extractor: extractor}
}
